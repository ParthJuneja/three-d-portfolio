...
const NewGlobe = () => {
  ...
  camera.position.set(1120.96, 203.21, -181.81);
  camera.quaternion.setFromEuler(new THREE.Euler(-3.11, 1.32, 3.12));
  ...
  loader.load(
    'https://prod.spline.design/XcrhQ1A6Ojcy0C71/scene.splinecode',
    (splineScene) => {
