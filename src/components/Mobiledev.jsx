                        ...
                        <div class="relative mt-10 lg:-mx-4 relative-20 lg:mt-0 lg:col-start-1">
                            <div class="relative space-y-4">
                                <div class="flex items-end justify-center space-x-4 lg:justify-start">
                                    <img class="w-32 rounded-lg shadow-lg md:w-56" width="200" src="src/assets/md1.jpg" alt="1" />
                                    <img class="w-40 rounded-lg shadow-lg md:w-64" width="260" src="src/assets/md2.jpg" alt="2" />
                                </div>
                                <div class="flex items-start justify-center ml-12 space-x-4 lg:justify-start">
                                    <img class="w-24 rounded-lg shadow-lg md:w-40" width="170" src="src/assets/md3.jpg" alt="3" />
                                    <img class="w-32 rounded-lg shadow-lg md:w-56" width="200" src="src/assets/md4.jpg" alt="4" />
                                </div>
                            </div>
                        </div>
                    </div>
